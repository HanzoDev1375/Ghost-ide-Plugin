...
public class JSON5Parser extends Parser {
	...
	public static final int
		...
		RPAREN=8, SINGLE_LINE_COMMENT=9, MULTI_LINE_COMMENT=10, LITERAL=11, STRING=12, 
		NUMBER=13, HEXCOLOR=14, NUMERIC_LITERAL=15, SYMBOL=16, IDENTIFIER=17, 
		WS=18;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RPAREN", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMMENT", "LITERAL", "STRING", 
			"NUMBER", "HEXCOLOR", "NUMERIC_LITERAL", "SYMBOL", "IDENTIFIER", "WS"
		};
	}
	...
	public final Json5Context json5() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 112650L) != 0)) {
				{
				setState(14);
				value();
				}
	...
	public static class ObjContext extends ParserRuleContext {
		public TerminalNode LCURLY() { return getToken(JSON5Parser.LCURLY, 0); }
		...
		public TerminalNode RCURLY() { return getToken(JSON5Parser.RCURLY, 0); }
	...
	public final KeyContext key() throws RecognitionException {
		...
		try {
			...
			setState(41);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 169984L) != 0)) ) {
	...
	public static class ArrContext extends ParserRuleContext {
		public TerminalNode LBRACKET() { return getToken(JSON5Parser.LBRACKET, 0); }
		...
		public TerminalNode RBRACKET() { return getToken(JSON5Parser.RBRACKET, 0); }
		public List<TerminalNode> COMMA() { return getTokens(JSON5Parser.COMMA); }
		public TerminalNode COMMA(int i) {
			return getToken(JSON5Parser.COMMA, i);
		}
