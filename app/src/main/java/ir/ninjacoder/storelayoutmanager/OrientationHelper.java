 ...
 *
 * <p>It is developed to easily support vertical and horizontal orientations in a LayoutManager but
...
public abstract class OrientationHelper {
  ...
  /**
   * Call this method after onLayout method is complete if state is NOT pre-layout. This method
   * records information like layout bounds that might be useful in the next layout calculations.
   */
   ...
   *
   * <p>Make sure you call {@link #onLayoutComplete()} at the end of your LayoutManager's {@link
   * RecyclerView.LayoutManager#onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} method.
   *
   ...
   *
   * <p>For example, for the horizontal helper, if a View's left is at pixel 20, has 2px left
   ...
   *
   * <p>For example, for the horizontal helper, if a View's right is at pixel 200, has 2px right
   ...
   * position.
   *
   * <p>This method is useful when trying to detect the visible edge of a View.
   *
   * <p>It includes the decorations but does not include the margins.
   *
   * @param view The view whose transformed end will be returned
   * @return The end of the View after its decor insets and transformation matrix is applied to its
   *     position
  ...
  /**
   * Returns the space occupied by this View in the perpendicular orientation including decorations
   * and margins.
   *
   * @param view The view element to check
  ...
  /**
   * Returns the total space to layout. This number is the difference between {@link
   * #getEndAfterPadding()} and {@link #getStartAfterPadding()}.
   *
  ...
  /**
   * Returns the padding at the end of the layout. For horizontal helper, this is the right padding
   * and for vertical helper, this is the bottom padding. This method does not check whether the
   * layout is RTL or not.
   *
