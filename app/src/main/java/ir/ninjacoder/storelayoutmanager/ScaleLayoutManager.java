...
/** An implementation of {@link ViewPagerLayoutManager} which zooms the center item */
...
public class ScaleLayoutManager extends ViewPagerLayoutManager {
  ...
  public ScaleLayoutManager(
      Context context, int itemSpace, int orientation, boolean reverseLayout) {
    this(
        new Builder(context, itemSpace)
